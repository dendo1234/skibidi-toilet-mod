...
public class CameraRenderer<T extends LivingEntity> {
    public CameraModel<T> model;

    public CameraRenderer(CameraModel<T> model) {
        this.model = model;
    }
...
/*     public ToiletRenderer(Context p_174289_) {
    ...
    private final static ResourceLocation cameraTexture = new ResourceLocation(SkibidiMod.MODID, "textures/camera_texture.png");
